...
export const ep76 = new Episode({
  ...
  interactions: [
    ...
    connectAll([Greg, Charley, Gerez, Stacy, Candace], 1),
    ...
    groupConnections([Candace, Stacy, Greg, Gerez, Charley, Holly, Ginger, Milly], [Baljeet, Buford, Ferb], 3),
